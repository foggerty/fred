...
{
    private const string NeedSingleConstructor =
        "{0} needs either a default (empty) constuctor or a single public constructor to be used in Fred's DI container.  He gets confused otherwise.  Sorry.";
